...
SECRET_KEY = "django-insecure-jy96q^w2&!@q(o1&uty_^lwn5gk^-jtf7o6*^ye+uapu0p41_g"
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            BASE_DIR.joinpath("static").joinpath("templates")
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
DATABASES = {
    ...
    "default": {
        ...
        "NAME": os.environ.get('POSTGRES_DB', 'lyrics'),
